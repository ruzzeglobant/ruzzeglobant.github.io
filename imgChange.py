...
for root, dirs, files in os.walk(cartella_target):
    for file in files:
        if file.lower().endswith(estensioni_immagini):
            ...
            try:
                ...
                print(f"Resa trasparente: {percorso}")

            except Exception as e:
                print(f"Errore con {percorso}: {e}")
